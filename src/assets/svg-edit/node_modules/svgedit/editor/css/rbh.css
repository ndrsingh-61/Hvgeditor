...
#tool_circle_cx:hover {
  ...
  /* .tool_button  .loaded #tool_path_cx:active {
    size: 115%;
    } */

 .menu .menu_title:hover {
  background-color:rgb(15, 5, 2);
  color:whitesmoke;
}
...
.popup_1 .form_1 .form-element_1{
margin: 15px 0px;
}

.popup_1 .form_1 .form-element_1 label{
font-size: 20px;
color: #222;
}

.popup_1 .form_1 .form-element_1 input[type="text"],
.popup_1 .form_1 .form-element_1 input[type="password"] {
  margin-top: 5px;
  display: block;
  width: 339px;
  padding: 10px;
...
.popup_1 .form_1 .form-element_1 input[type="checkbox"] {
  margin-right: 5px;
}
.popup_1 .form_1 .form-element_1 button{
width: 100%;
height: 40px;
border: none;
outline: none;
...
.popup_1 .form_1 .form-element_1 a{
  display: block;
  text-align: right;
  font-size: 15px;
  color: #1a79ca;
...
/* popop */
  ...
  .resize-handle-left[_ngcontent-ilp-c284] {
    position: absolute;
    height: 100%;
    cursor: col-resize;
    width: 5px;
...
.container_1{
  ...
  #check:checked ~ .container_1 {
      transform: translate(0)
  }
  #check:checked ~ .container_1 #bars {
  display: none;
  }
...
.tool_button.current {
 ...
 #tools_left .tool_button.loaded:hover { background:transparent;}
...
input[type=submit] {
 ...
 #tools_left {
  ...
  top: 35px;
  bottom: 0;
  /* border-bottom: solid rgb(12, 11, 10) 5px; */
  border-bottom: solid rgb(241, 93, 39) 5px;
  left: 0;
  background: #1e2433; 
  z-index: 4;
}
...
.svg_editor_top
{
  /* border-top: solid rgb(19, 17, 16) 5px; */
  border-top: solid rgb(241, 93, 39) 5px;
  margin-top: 0.2px;
}
 #tools_bottom {
  position: absolute;
...
#tools_bottom_3
{
  /* border-bottom: solid rgb(19, 17, 16) 5px; */
  border-bottom: solid rgb(241, 93, 39) 5px;
  margin-top: 35px;
  width: 115%;
}
...
#tools_top.multiselected #multiselected_panel .hidable {
 ...
 .draginput_cell {
  ...
  position: relative;
  /* border-top: solid rgb(241, 93, 39) 5px; */
  border-top: solid rgb(241, 93, 39);
  border-radius: 0px;
  background:transparent;
  z-index: 2;
}
...
#shape_cats div.current:after {
  ...
  /* border-left-color:#f15d27; */
  border-left-color: rgb(241, 93, 39);
}
...
#dialog_container {
  ...
  z-index:50001;
  background: #fff;
  /* border-top: solid rgb(241, 93, 39) 4px; */
  border-top: solid rgb(241, 93, 39) 4px;
}
...
#logo{
  ...
  margin-left: 8px;
  vertical-align: top;
  background-image: url(../images/rbhlogo.png);
  background-repeat: no-repeat
}
#menu {
  display: none;
...
#confirmBox .button {
  ...
  display: inline-block;
  border-radius: 3px;
  border: 1px solid rgb(241, 93, 39);
  padding: 2px;
  text-align: center;
  width: 80px;
  cursor: pointer;
...
#preview_font {
  ...
  width: 100px;
  overflow: hidden;
  border-right: solid rgb(241, 93, 39) 2px;
  position: relative;
}
...
.Properties_value {
  ...
  box-sizing: border-box;
  border: none;
  border-bottom: 1px solid rgb(241, 93, 39);
}
.sidebarbackground{
  width: 100%;
  height: 0.6%;
