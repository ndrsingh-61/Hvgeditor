...
(function() {
  ...
  //              // opts.button, default, position
      ...
      function saveproperties()
      {
        if (selectedElement != null)
        {
          var value= document.getElementById("General");
          selectedElement.setAttribute("data-path",document.getElementById("general_data_path").value);
          selectedElement.setAttribute("data-constantval",document.getElementById("general_data_constantval").value);
          var dataelement ={
            name: document.getElementById("data_element_name").value==null?"":document.getElementById("data_element_name").value,
            type: document.getElementById("data_element_type").value==null?"":document.getElementById("data_element_type").value,
            target:document.getElementById("data_element_target").value==null?"":document.getElementById("data_element_target").value,
          }
          console.log(JSON.stringify(dataelement));
          selectedElement.setAttribute("data-element","["+ JSON.stringify(dataelement)+"]");
          var dataselection= {
            name: document.getElementById("data_selection_type").value==null?"":document.getElementById("data_selection_type").value,
            type: document.getElementById("data_selection_target").value==null?"":document.getElementById("data_selection_target").value,
            x:document.getElementById("data_selection_xaxis").value==null?"":document.getElementById("data_selection_xaxis").value,
            y: document.getElementById("data_selection_yaxis").value==null?"":document.getElementById("data_selection_yaxis").value,
            width: document.getElementById("data_element_width").value==null?"":document.getElementById("data_element_width").value,
            height:document.getElementById("data_element_height").value==null?"":document.getElementById("data_element_height").value
          }
          selectedElement.setAttribute("data-selection",JSON.stringify(dataselection));
        }
      }

      function openproperties(){
        document.getElementById("resizer").style.width = "21%";
      }
      ...
      var ul = document.getElementById('tab_settings'); // Parent
      ul.addEventListener('click', function (e) {
        var tabname = getEventTarget(e);
         if(tabname.id=="li_general"){
          document.getElementById("General").style.display="block";
          document.getElementById("Data_Element").style.display="none";
          document.getElementById("Data_selection").style.display="none";
         }
         else if(tabname.id=="li_dataelement"){
          document.getElementById("General").style.display="none";
          document.getElementById("Data_Element").style.display="block";
          document.getElementById("Data_selection").style.display="none";
         }
         else if(tabname.id=="li_dataselection"){
          document.getElementById("General").style.display="none";
          document.getElementById("Data_Element").style.display="none";
          document.getElementById("Data_selection").style.display="block";
         }
         else if(tabname.id=="tools_properties_Save"){}
         else {
         document.getElementById("General").style.display="block";
         document.getElementById("Data_Element").style.display="none";
         document.getElementById("Data_selection").style.display="none";
      ...
      function add() {
        reqs_id++; // increment reqs_id to get a unique ID for the new element
          ...
          input.type = "text";
          input.setAttribute("class", "Properties_value");
          ...
          remove.setAttribute("class", "btn_remove");
     ...
     $('#resolution').change(function(){
      ...
      var Actions = function() {
         var tool_buttons = [
          ...
          {sel:'#tools_properties_Save', fn: saveproperties, evt: 'click'},
          {sel:'#tools_constant_Save', fn: toolsconstantval, evt: 'click'},
          {sel:'#tools_properties', fn: openproperties, evt: 'click'},
